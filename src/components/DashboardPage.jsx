...
function DashboardPage() {
    ...
    if (loading) {
        return <div style={{ padding: '2rem', textAlign: 'center' }}>Loading alumni directory...</div>;
    }
    ...
    const programColors = {
        'AVCN': getComputedStyle(document.documentElement).getPropertyValue('--primary-color') || '#E53935',
        'AAVC': getComputedStyle(document.documentElement).getPropertyValue('--secondary-color') || '#42A5F5',
    };
